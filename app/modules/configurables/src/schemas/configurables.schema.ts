...
export const configurableSchemas: ConfigurableSchemas = {
  formSchema: [
    ...
    {
      fieldName: "maxEmailsPerDay",
      type: "number",
      required: false,
      label: "Max Coaching Emails Per Day",
      min: 1,
      max: 50,
    },
    {
      fieldName: "enableResumeReminders",
      type: "boolean",
      required: false,
      label: "Enable Resume Update Reminders",
    },
    {
      fieldName: "enableSkillSuggestions",
      type: "boolean",
      required: false,
      label: "Enable Skill Learning Suggestions",
    },
    {
      fieldName: "enableCertRecommendations",
      type: "boolean",
      required: false,
      label: "Enable Certification Recommendations",
    },
    {
      fieldName: "enableInterviewPrep",
      type: "boolean",
      required: false,
      label: "Enable Interview Prep Reminders",
    },
    {
      fieldName: "enableMockInterviews",
      type: "boolean",
      required: false,
      label: "Enable Mock Interview Invitations",
    },
    {
      fieldName: "enableProgressSummaries",
      type: "boolean",
      required: false,
      label: "Enable Progress Summaries",
    },
    {
      fieldName: "enableJobNudges",
      type: "boolean",
      required: false,
      label: "Enable Job Application Nudges",
    },
    {
      fieldName: "enableAtsTips",
      type: "boolean",
      required: false,
      label: "Enable ATS Optimization Tips",
    },
    {
      fieldName: "enableMilestones",
      type: "boolean",
      required: false,
      label: "Enable Milestone Celebrations",
    },
    {
      fieldName: "defaultFrequency",
      type: "enum",
      required: false,
      label: "Default Email Frequency",
