...
import notificationPrefsRoutes from "~/notification-prefs/api/notification-prefs.routes";
import { requireAuth, requireAdmin } from "~/modules/authentication/authentication.middleware";
// Initialize notification-prefs model (outside auto-discovery path)
import "~/notification-prefs/api/notification-prefs.model";
...
router.use("/api/notification-prefs", requireAuth, notificationPrefsRoutes);
// </AUTO-GENERATED:ROUTES>
